...
import { deepMerge } from '../api/_lib/homeContent.mjs';

const rootDir = path.join(path.dirname(fileURLToPath(import.meta.url)), '..');
const dataPath = path.join(rootDir, 'api/_data/home-content.json');
const frontendDataPath = path.join(rootDir, 'src/data/home-content.json');
        ...
        try {
          if (url === '/api/home-content') {
            ...
            if (req.method === 'POST') {
              ...
              fs.writeFileSync(frontendDataPath, serialized);
