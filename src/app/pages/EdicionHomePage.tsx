...
const SECTIONS = ['Hero', 'Banner CTA', 'Quiénes somos', 'Beneficios', 'Carruseles'] as const;
    ...
    <div className="space-y-2">
      ...
      <div
        ...
        className={`rounded-xl border-2 border-dashed p-3 transition-colors ${
          dragOver ? 'border-[#0c3c1f] bg-blue-50' : 'border-gray-200 bg-gray-50'
        }`}
      >
        {displaySrc ? (
          ...
          >
            {uploading ? (
              <Loader2 className="w-8 h-8 text-[#0c3c1f] animate-spin" />
            ) : (
              <Upload className="w-8 h-8 text-[#0c3c1f]" />
            )}
      ...
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <form onSubmit={handleLogin} className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm">
          ...
          <div className="flex items-center gap-2 mb-6 justify-center">
            ...
            <h1 className="text-xl font-bold text-[#0c3c1f]">Edición del Home</h1>
          </div>
          <input
            type="text"
            value={username}
    ...
    <div className="min-h-screen bg-gray-100">
      <header className="bg-[#0c3c1f] text-white px-4 py-4 flex items-center justify-between sticky top-0 z-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-white text-[#0c3c1f] hover:bg-gray-100 px-4 py-2 rounded-lg text-sm font-bold transition-colors disabled:opacity-60"
          >
      ...
      <div className="flex flex-col md:flex-row max-w-6xl mx-auto p-4 gap-4">
        ...
        <main className="flex-1 bg-white rounded-xl shadow-sm p-6 space-y-5">
          ...
          {activeSection === 'Hero' && (
            <>
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-2 text-[#0c3c1f] font-bold">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg bg-[#0c3c1f] px-3 py-2 text-xs font-semibold text-white hover:bg-[#0a3019] disabled:opacity-50"
                >
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <TextInput
                          ...
                          placeholder="/categorias/mr-brown-days o https://…"
                        />
          ...
          {activeSection === 'Banner CTA' && (
            <>
              <div className="flex items-center gap-2 text-[#0c3c1f] font-bold">
                <Image className="w-5 h-5" />
                Banner CTA (evento / promo)
              </div>
              <ImageFields
              ...
              <div>
                <FieldLabel>Link del botón</FieldLabel>
                <TextInput
                  value={content.registerBanner.buttonHref || ''}
                  onChange={(v) =>
                    setContent((c) => ({
                      ...c,
                      registerBanner: { ...c.registerBanner, buttonHref: v },
                    }))
                  }
                  placeholder="/cotizar-evento o https://…"
                />
                <p className="mt-1 text-xs text-gray-500">Vacío = /cotizar-evento.</p>
              </div>
            </>
          )}
